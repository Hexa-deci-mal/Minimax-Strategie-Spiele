...
def create_board ():
    ...
    cell11 = Button(checkersBoard, command=lambda:[doAppropriateButtonAction(0,0,GameMode,cell11)], width=15, height=7)
    cell12 = Button(checkersBoard, command=lambda:[doAppropriateButtonAction(0,1,GameMode,cell12)], width=15, height=7)
    cell13 = Button(checkersBoard, command=lambda:[doAppropriateButtonAction(0,2,GameMode,cell13)], width=15, height=7)
    cell14 = Button(checkersBoard, command=lambda:[doAppropriateButtonAction(0,3,GameMode,cell14)], width=15, height=7)
    cell15 = Button(checkersBoard, command=lambda:[doAppropriateButtonAction(0,4,GameMode,cell15)], width=15, height=7)
    cell16 = Button(checkersBoard, command=lambda:[doAppropriateButtonAction(0,5,GameMode,cell16)], width=15, height=7)
    ...
    cell21 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(1,0,GameMode,cell21)], width=15, height=7)
    cell22 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(1,1,GameMode,cell22)], width=15, height=7)
    cell23 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(1,2,GameMode,cell23)], width=15, height=7)
    cell24 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(1,3,GameMode,cell24)], width=15, height=7)
    cell25 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(1,4,GameMode,cell25)], width=15, height=7)
    cell26 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(1,5,GameMode,cell26)], width=15, height=7)
    ...
    cell31 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(2,0,GameMode,cell31)], width=15, height=7)
    cell32 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(2,1,GameMode,cell32)], width=15, height=7)
    cell33 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(2,2,GameMode,cell33)], width=15, height=7)
    cell34 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(2,3,GameMode,cell34)], width=15, height=7)
    cell35 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(2,4,GameMode,cell35)], width=15, height=7)
    cell36 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(2,5,GameMode,cell36)], width=15, height=7)
    ...
    cell41 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(3,0,GameMode,cell41)], width=15, height=7)
    cell42 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(3,1,GameMode,cell42)], width=15, height=7)
    cell43 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(3,2,GameMode,cell43)], width=15, height=7)
    cell44 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(3,3,GameMode,cell44)], width=15, height=7)
    cell45 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(3,4,GameMode,cell45)], width=15, height=7)
    cell46 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(3,5,GameMode,cell46)], width=15, height=7)
    ...
    cell51 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(4,0,GameMode,cell51)], width=15, height=7)
    cell52 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(4,1,GameMode,cell52)], width=15, height=7)
    cell53 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(4,2,GameMode,cell53)], width=15, height=7)
    cell54 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(4,3,GameMode,cell54)], width=15, height=7)
    cell55 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(4,4,GameMode,cell55)], width=15, height=7)
    cell56 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(4,5,GameMode,cell56)], width=15, height=7)
    ...
    cell61 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(5,0,GameMode,cell61)], width=15, height=7)
    cell62 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(5,1,GameMode,cell62)], width=15, height=7)
    cell63 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(5,2,GameMode,cell63)], width=15, height=7)
    cell64 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(5,3,GameMode,cell64)], width=15, height=7)
    cell65 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(5,4,GameMode,cell65)], width=15, height=7)
    cell66 = Button(checkersBoard,command=lambda:[doAppropriateButtonAction(5,5,GameMode,cell66)], width=15, height=7)
